...
<div class="col-sm-6 col-md-3" style="height: 490px">
  <div class="thumbnail">
    <a href="index.php?page=produto&id=<?php echo $value['id_produto']; ?>"><img style="width:220px; height:220px" src="src/template/Includes/thumb/<?php echo $value['thumb']; ?>" alt="<?php echo $value['nome_produto'];?>"/></a>
    <div class="caption">
